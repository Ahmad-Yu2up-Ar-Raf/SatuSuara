...
const [showPassword, setShowPassword] = useState(false);
  ...
  return (
    <div className=" h-full flex items-center justify-center overflow-hidden ">
      <div
        className={cn(
          "  min-h-lvh grid lg:grid-cols-2 w-full relative max-w-lg  overflow-hidden  shadow-xl lg:max-w-none h-lvh",
          className
        )}>
          <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-foreground via-primary to-foreground/80 text-primary-foreground py-7 px-11.5">
        <div className="relative z-20">
          <div className="flex items-center gap-4  font-semibold">
            <div className="size-8 rounded-lg  bg-white backdrop-blur-sm flex items-center justify-center">
              <LogoWhiter className="size-5" />
            </div>
            <span>SatuSuara</span>
          </div>
        </div>
        ...
        <div className="relative z-20 flex items-end justify-center h-[500px]">
          ...
          <div className="relative" style={{ width: '550px', height: '400px' }}>
            ...
            >
              ...
              <div 
                className="absolute w-20 h-[4px] bg-[#2D2D2D] rounded-xl transition-all duration-200 ease-out"
                style={{
        ...
        <div className="absolute top-1/4 right-1/4 size-64 bg-primary-foreground/10 rounded-xl blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 size-96 bg-primary-foreground/5 rounded-xl blur-3xl" />
      </div>


       <div className="flex items-center justify-center relative p-8 bg-background">
        <div className="w-full max-w-[400px]">
            <div className="flex justify-center text-center flex-col items-left mb-8">
              <div className={cn(" top-3 right-1/2  left-1/2  absolute mb-4  m-auto md:sr-only  ")}>
                <Logo className=""/>
              </div>
