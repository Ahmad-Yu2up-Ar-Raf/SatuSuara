import MarqueeAlongSvgPath from "../../fragments/custom-ui/animate-ui/marquee-along-svg-path"
...
export default function MarqueeAlongSvgPathDemo() {
  return (
    <div className="w-full relative min-h-[40svh]  flex">
      <MarqueeAlongSvgPath
        path={path}
        baseVelocity={8}
        ...
        repeat={2}
        dragSensitivity={0.1}
        className="absolute -left-24 sm:-left-32 top-0 scale-60 sm:scale-100"
        grabCursor
      >
        {imgs.map((img, i) => (
          <div
