...
import { InfiniteSlider } from '../animate-ui/infinite-slider'
import { ProgressiveBlur } from '../../shadcn-ui/progressive-blur'
    ...
    return (
        <>
            ...
            <main className="overflow-x-hidden">
                <section className=' min-h-lvh overflow-hidden'>
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-white text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl">Build 10x Faster with NS</h1>
                                ...
                                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                                    <Button
                                        asChild
                                        size="lg"
                                        className="h-12 rounded-xl pl-5 pr-3 text-base">
                                        <Link href="#link">
                                    ...
                                    <Button
                                        ...
                                        size="lg"
                                        variant="ghost"
                                        className="h-12 rounded-xl px-5 text-base hover:bg-zinc-950/5 dark:hover:bg-white/5">
                                        <Link href="#link">
        ...
        muted
        playsInline
        className="absolute brightness-60 top-0 left-0 w-full h-full object-cover"
      >
        <source
    ...
    return (
        <header>
            <nav
                ...
                className="group  sticky top-0 z-20 w-full pt-2">
