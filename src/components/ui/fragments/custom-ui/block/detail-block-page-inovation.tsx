        ...
        <div className="md:col-span-5 space-y-6">
          ...
          <Card className="p-6">
            <div className="space-y-6">
              ...
              <div className="grid gap- sr-only">
                <AlertDialog>
                  <AlertDialogTrigger >
                    <Button 
                      size="lg" 
                      className="w-full group active:scale-98 transition-transform"
                  ...
                  {/* Alert Dialog Content preserved */}
                </AlertDialog>

                <Button
                  size="lg"
                  variant="outline"
                  className="w-full group sr-only active:scale-98 transition-transform"
                  onClick={handleDonate}
                  data-testid="donate-button"
                >
                  <HeartHandshake className="w-4 h-4 mr-2 group-hover:scale-110 transition-transform" />
                  Donasi
                </Button>
              </div>
            </div>
