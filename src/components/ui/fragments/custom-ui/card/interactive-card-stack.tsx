  ...
  return (
    <>
      ...
      >
                  ...
                  <div className="flex items-center gap-3 w-full justify-between pr-2 pl-1">
                    <div className="flex items-center gap-2">
                      <img
                        ...
                        height={20}
                      />
                      <span className="textbackground font-medium -ml-0.5">
                        {card.name}
                      </span>
                    </div>
                    <span className="textbackground font-medium">
        ...
        <div
          className="pointer-events-none absolute -top-12 left-0 w-full pt-[100px] pb-[80px] bg-gradient-to-b frombackground to-transparent z-20"
